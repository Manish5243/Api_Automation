...
public class payLoad {
	...
	public static String AddPlaceHost(String name) {
		return "{\r\n"
				+ "  \"location\": {\r\n"
				+ "    \"lat\": -38.383494,\r\n"
				+ "    \"lng\": 33.427362\r\n"
	...
	public static String UpdatePlaceResource() {
	...
	public static String DeleteAddrees(String ID) {
		return "{\r\n"
				+ "    \"place_id\":\""+ID+"\"\r\n"
				+ "}\r\n"
				+ "";
	}
	public static String DeleteAddressResource() {
